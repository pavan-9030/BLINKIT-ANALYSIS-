...
This project focuses on analyzing Blinkit grocery sales data using SQL. The main objective was to clean the dataset, standardize inconsistent values, and generate meaningful business insights using multiple KPIs and analytical queries.

The analysis helps in understanding sales performance, outlet behavior, product category contributions, and customer rating trends across the Blinkit platform.

Data Cleaning

To maintain data consistency, the Item_Fat_Content field was standardized.

Converted variations like LF and low fat into Low Fat
Converted reg into Regular
UPDATE blinkit_data
...
✔ Ensured accuracy in reporting and filtering
✔ Removed duplicate category variations
